...
async function seedHomeGroups() {
  const groups = [
    ...
    },
    {
      ...
      photos: [
        '/images/groups/youth/1.jpg',
        '/images/groups/youth/2.jpg',
        '/images/groups/youth/3.jpg',
        '/images/groups/youth/4.jpg',
        '/images/groups/youth/5.jpg',
        '/images/groups/youth/6.jpg',
        '/images/groups/youth/7.jpg',
        '/images/groups/youth/8.jpg',
        '/images/groups/youth/9.jpg',
        '/images/groups/youth/10.jpg',
      ],
      order: 8,
    },
  ];
